...
export class ViewSubjectListBySchoolAndCourseComponent
  ...
  implements OnInit
{
  ...
  getSubjectNames() {
    ...
    if (this.courseListStatus == 1) {
      ...
      this.CourseInstructorService.getCourseInfobySchoolAndCourse(
        this.baseSchoolNameId,
        courseNameId,
        this.courseDurationId
      ).subscribe((res) => {
      ...
      this.CourseInstructorService.getInstructorListBySchoolAndCourse(
        this.baseSchoolNameId,
        courseNameId,
        this.courseDurationId
      ).subscribe((res) => {
    ...
    this.BNASubjectNameService.getSelectedsubjectsBySchoolAndCourse(
      ...
      const groups = this.SelectedsubjectsBySchoolAndCourse.reduce(
        (groups, courses) => {
    ...
    this.CourseInstructorService.getSubjectTotalByCourseId(
      this.baseSchoolNameId,
      courseNameId
    ).subscribe((res) => {
