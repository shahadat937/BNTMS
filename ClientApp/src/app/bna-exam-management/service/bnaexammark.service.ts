...
export class BNAExamMarkService {
  ...
  getExamMarkListByParameters(baseSchoolNameId,courseDurationId,traineeId){
    return this.http.get<SubjectMark[]>(this.baseUrl + '/bna-exam-mark/get-traineeMarkListByParameters?courseDurationId='+courseDurationId+'&baseSchoolNameId='+baseSchoolNameId+'&traineeId='+traineeId);
  }

  getTraineePerformanceDetailsByParameters(baseSchoolNameId,courseDurationId,traineeId){
    return this.http.get<any[]>(this.baseUrl + '/bna-exam-mark/get-traineePerformanceDetailsByParameters?courseDurationId='+courseDurationId+'&baseSchoolNameId='+baseSchoolNameId+'&traineeId='+traineeId);
  }

  getTraineeCertificateDetailsByParameters(baseSchoolNameId,courseDurationId,traineeId){
    return this.http.get<any[]>(this.baseUrl + '/bna-exam-mark/get-traineeCertificateDetailsByParameters?courseDurationId='+courseDurationId+'&baseSchoolNameId='+baseSchoolNameId+'&traineeId='+traineeId);
  }
