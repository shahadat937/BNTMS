...
export class TraineeNominationService {
  ...
  getTraineeNominationByCourseDurationId(courseDurationId:number){
    return this.http.get<TraineeListforForeignCourse[]>(this.baseUrl + '/trainee-nomination/get-traineeNominationsForAttendanceByCourseDurationId?courseDurationId='+courseDurationId);
  }

  getTestTraineeNominationByCourseDurationId(courseDurationId:number){
    return this.http.get<TraineeListForExamMark[]>(this.baseUrl + '/trainee-nomination/get-traineeNominationsForAttendanceByCourseDurationId?courseDurationId='+courseDurationId);
  }
