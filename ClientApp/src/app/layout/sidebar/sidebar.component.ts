...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (this.authService.currentUserValue) {
      ...
      } else if (userRole === Role.BNASchool) {
        this.userType = Role.BNASchool;
      } else if (userRole === Role.JSTISchool) {
        this.userType = Role.JSTISchool;
      } else if (userRole === Role.Student) {
        this.userType = Role.Student;
      } else if (userRole === Role.Instructor) {
        this.userType = Role.Instructor;
      }
      else if (userRole === Role.MIST) {
        this.userType = Role.MIST;
      } 
      else {
        this.userType = Role.MasterAdmin;
      }
