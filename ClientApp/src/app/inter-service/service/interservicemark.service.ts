...
export class InterServiceMarkService {
  ...
  // }
  getCourseNameByOrganizationNameId(id: number) {
    return this.http.get<SelectedModel[]>(this.baseUrl + '/course-duration/get-selectedCourseNameByOrganizationNameId?organizationNameId=' + id);
  }
