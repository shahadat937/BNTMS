...
export class NewAllowancePercentageComponent
    ...
    if (id) {
      this.confirmService
        ...
        .subscribe((result) => {
          if (result) {
            this.loading = true;
            this.AllowancePercentageService.update(
              +id,
              this.AllowancePercentageForm.value
            ).subscribe(
              (response) => {
                this.router.navigateByUrl(
                  "/allowance-management/allowancepercentage-list"
                );
      ...
      this.loading = true;
      this.AllowancePercentageService.submit(
        this.AllowancePercentageForm.value
      ).subscribe(
        (response) => {
          this.router.navigateByUrl(
