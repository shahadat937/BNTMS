  ...
  implements OnInit
{
  ...
  onToRankSelectionChanged(item) {
    ...
    this.AllowanceCategoryService.getAllowanceCategoryListByFromRankIdAndToRankId(
      this.fromRankId,
      this.toRankId
    ).subscribe((response) => {
  ...
  onCountryGroupSelectionChangeGetCountry(countryGroupId) {
    this.AllowanceCategoryService.getCountryByCountryGroupId(
      countryGroupId
    ).subscribe((res) => {
  ...
  getselectedAllowancePercentages() {
    this.AllowanceCategoryService.getselectedAllowancePercentages().subscribe(
      (res) => {
    ...
    if (id) {
      this.confirmService
        ...
        .subscribe((result) => {
          if (result) {
            this.loading = true;
            this.AllowanceCategoryService.update(
              +id,
              this.AllowanceCategoryForm.value
            ).subscribe(
              (response) => {
                this.router.navigateByUrl(
                  "/allowance-management/allowancecategory-list"
                );
      ...
      this.loading = true;
      this.AllowanceCategoryService.submit(
        this.AllowanceCategoryForm.value
      ).subscribe(
        (response) => {
          this.router.navigateByUrl(
