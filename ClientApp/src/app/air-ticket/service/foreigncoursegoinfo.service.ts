...
import {
  IForeignCourseGOInfoPagination,
  ForeignCourseGOInfoPagination,
} from "../models/ForeignCourseGOInfoPagination";
...
export class ForeignCourseGOInfoService {
  ...
  getForeignCourseGOInfos(pageNumber, pageSize, searchText) {
    ...
    return this.http
      .get<IForeignCourseGOInfoPagination>(
        this.baseUrl + "/foreign-course-go-info/get-ForeignCourseGOInfos",
        { observe: "response", params }
      )
      .pipe(
        map((response) => {
          this.ForeignCourseGOInfos = [
            ...this.ForeignCourseGOInfos,
            ...response.body.items,
          ];
  ...
  find(id: number) {
    return this.http.get<ForeignCourseGOInfo>(
      this.baseUrl +
        "/foreign-course-go-info/get-ForeignCourseGOInfoDetail/" +
        id
    );
  }
  update(id: number, model: any) {
    return this.http.put(
      this.baseUrl + "/foreign-course-go-info/update-ForeignCourseGOInfo/" + id,
      model
    );
  }
  submit(model: any) {
    return this.http
      .post<PostResponse>(
        this.baseUrl + "/foreign-course-go-info/save-ForeignCourseGOInfo",
        model
      )
      .pipe(
  ...
  delete(id: number) {
    return this.http.delete(
      this.baseUrl + "/foreign-course-go-info/delete-ForeignCourseGOInfo/" + id
    );
  }
}
