...
import {
  IForeignCourseOtherDocumentPagination,
  ForeignCourseOtherDocumentPagination,
} from "../models/ForeignCourseOtherDocumentPagination";
...
export class ForeignCourseOtherDocumentService {
  ...
  ForeignCourseOtherDocumentPagination =
    new ForeignCourseOtherDocumentPagination();
  ...
  getselectedDocType() {
    return this.http.get<SelectedModel[]>(
      this.baseUrl + "/foreign-course-doctype/get-selectedForeignCourseDocTypes"
    );
  }
  ...
  getForeignCourseOtherDocuments(
    ...
    return this.http
      .get<IForeignCourseOtherDocumentPagination>(
        this.baseUrl +
      ...
      .pipe(
        map((response) => {
          this.ForeignCourseOtherDocuments = [
            ...this.ForeignCourseOtherDocuments,
            ...response.body.items,
          ];
  ...
  //foreign-course-others-document/get-foreignCourseOthersDocuments
  getForeignCourseOtherDocumentByCourseDurationIdandTraineId(
    courseNameId,
    courseDurationId
  ) {
  ...
  find(id: number) {
    return this.http.get<ForeignCourseOtherDocument>(
      this.baseUrl +
        "/foreign-course-others-document/get-foreignCourseOthersDocumentDetail/" +
        id
    );
  }
  update(id: number, model: any) {
    return this.http.put(
      this.baseUrl +
        "/foreign-course-others-document/update-foreignCourseOthersDocument/" +
        id,
      model
    );
  }
  submit(model: any) {
    return this.http
      .post<PostResponse>(
        this.baseUrl +
          "/foreign-course-others-document/save-foreignCourseOthersDocument",
        model
      )
      .pipe(
  ...
  delete(id: number) {
    return this.http.delete(
      this.baseUrl +
        "/foreign-course-others-document/delete-foreignCourseOthersDocument/" +
        id
    );
  }
}
