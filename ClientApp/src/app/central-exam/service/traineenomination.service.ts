...
import { BIODataGeneralInfo } from 'src/app/trainee-biodata/biodata-tab-layout/models/BIODataGeneralInfo';
...
export class TraineeNominationService {
  ...
  getNominatedTraineeDate(traineeId){
    return this.http.get<BIODataGeneralInfo>(this.baseUrl + '/trainee-bio-data-general-info/get-traineedetail/'+traineeId);
  }
