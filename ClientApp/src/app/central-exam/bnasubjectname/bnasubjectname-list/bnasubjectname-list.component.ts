...
export class BNASubjectNameListComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  displayedColumns: string[] = ['ser','subjectName','subjectType', 'totalMark','passMarkBna', 'qExamTime', 'resultStatusId', 'remarks',  'actions'];
