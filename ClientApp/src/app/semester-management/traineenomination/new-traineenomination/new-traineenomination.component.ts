...
//autocomplete
// getSelectedTraineeByPno(pno,bnaSemesterDurationId,courseDurationId,courseNameId){
//   this.TraineeNominationService.getSelectedTraineeByparameterForBnaRequest(pno,bnaSemesterDurationId,courseDurationId,courseNameId).subscribe(response => {
