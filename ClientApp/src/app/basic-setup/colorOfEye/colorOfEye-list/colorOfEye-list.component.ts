...
export class ColorOfEyeListComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private snackBar: MatSnackBar,private colorOfEyeService: ColorOfEyeService,private router: Router,private confirmService: ConfirmService) { }
