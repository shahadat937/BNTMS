...
export class NewTraineeCourseStatusComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  loading = false;
  pageTitle: string;
  destination:string;
  ...
  constructor(private snackBar: MatSnackBar,private confirmService: ConfirmService,private TraineeCourseStatusService: TraineeCourseStatusService,private fb: FormBuilder, private router: Router,  private route: ActivatedRoute, public sharedService: SharedServiceService) {
    super();
  }
