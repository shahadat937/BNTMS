...
export class TraineeCourseStatusListComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private TraineeCourseStatusService: TraineeCourseStatusService,private router: Router,private confirmService: ConfirmService, public sharedService: SharedServiceService) {
    super();
  }
  // ngOnInit() {
