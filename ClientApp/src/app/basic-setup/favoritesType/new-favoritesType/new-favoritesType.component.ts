...
export class NewFavoritesTypeComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  buttonText:string;
  loading = false;
  pageTitle: string;
  destination:string;
  ...
  constructor(
    ...
    private favoritesTypeService: FavoritesTypeService,private fb: FormBuilder, 
