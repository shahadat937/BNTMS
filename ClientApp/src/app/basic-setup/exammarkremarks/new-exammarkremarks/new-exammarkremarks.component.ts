...
export class NewExamMarkRemarksComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  buttonText:string;
  loading = false;
  pageTitle: string;
  destination:string;
  ...
  constructor(
    ...
    private ExamMarkRemarksService: ExamMarkRemarksService,private fb: FormBuilder, 
