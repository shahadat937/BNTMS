...
export class NewBNAInstructorTypeComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private BNAInstructorTypeService: BNAInstructorTypeService,
  ...
  ngOnInit(): void {
    ...
    if (id) {
      ...
      this.btnText = "Update";
      this.BNAInstructorTypeService.find(+id).subscribe((res) => {
    ...
    if (id) {
      this.confirmService
        ...
        .subscribe((result) => {
          if (result) {
            this.loading = true;
            this.BNAInstructorTypeService.update(
              +id,
              this.BNAInstructorTypeForm.value
            ).subscribe(
              (response) => {
                this.router.navigateByUrl(
                  "/basic-setup/bnainstructortype-list"
                );
      ...
      this.loading = true;
      this.BNAInstructorTypeService.submit(
        this.BNAInstructorTypeForm.value
      ).subscribe(
        (response) => {
