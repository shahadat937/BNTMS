...
export class WithdrawnDocListComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private WithdrawnDocService: WithdrawnDocService,private router: Router,private confirmService: ConfirmService) { }
