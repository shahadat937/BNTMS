...
export class NewWithdrawnDocComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  loading = false;
  pageTitle: string;
  destination:string;
  ...
  constructor(private snackBar: MatSnackBar,private confirmService: ConfirmService,private WithdrawnDocService: WithdrawnDocService,private fb: FormBuilder, private router: Router,  private route: ActivatedRoute, public sharedService: SharedServiceService) {
    super();
  }
