...
export class NewEntryEvaluationListComponent implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute,private snackBar: MatSnackBar,private NewEntryEvaluationService: NewEntryEvaluationService,private router: Router,private confirmService: ConfirmService, public sharedService: SharedServiceService) { }
