...
@Component({
  selector: 'app-civil-biodata-info-list',
  templateUrl: './civil-biodata-info-list.component.html',
  styleUrls: ['./civil-biodata-info-list.component.sass']
})
export class CivilBiodataInfoListComponent implements OnInit, OnDestroy {
 ...
 @ViewChild('fileInput') fileInput!: ElementRef;
   ...
   getBIODataGeneralInfos() {
     this.isLoading = true;
     this.BIODataGeneralInfoService. getBIODataGeneralInfosForCivil(this.paging.pageIndex, this.paging.pageSize, this.searchText, this.civilStatusId)
       .subscribe(
         response => {
           this.dataSource.data = response.items; 
           this.paging.length = response.totalItemsCount;    
   ...
   onFileSelected(event: Event) {
     ...
     if (file) {
       // this.loading = true;
       this.BIODataGeneralInfoService.uploadFile(file, this.civilStatusId).subscribe(
         (response: any) => {
