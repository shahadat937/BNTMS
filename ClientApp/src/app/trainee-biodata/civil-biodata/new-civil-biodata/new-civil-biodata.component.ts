...
@Component({
  selector: 'app-new-civil-biodata',
  templateUrl: './new-civil-biodata.component.html',
  styleUrls: ['./new-civil-biodata.component.sass']
})
export class NewCivilBiodataComponent implements OnInit, OnDestroy {
 ...
 ngOnInit(): void {
   ...
   if (id) {
     this.pageTitle = 'Edit Civil BIO Data';
...
filterByCaste(value:any){
 ...
 intitializeForm() {
   ...
   this.BIODataGeneralInfoForm = this.fb.group({
     ...
     hairColorId: [''],
     officerTypeId: [''],
     traineeStatusId:['10'], // civil Trainee
