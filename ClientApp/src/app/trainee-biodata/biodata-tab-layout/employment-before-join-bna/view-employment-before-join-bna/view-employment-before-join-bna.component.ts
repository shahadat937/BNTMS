...
export class ViewEmploymentBeforeJoinBNAComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscription = this.EmploymentBeforeJoinBNAService.find(+id).subscribe( res => {
