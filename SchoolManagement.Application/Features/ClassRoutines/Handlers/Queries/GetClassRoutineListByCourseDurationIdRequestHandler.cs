...
{
    public class GetClassRoutineListByCourseDurationIdRequestHandler : IRequestHandler<GetClassRoutineListByCourseDurationIdRequest, PagedResult<ClassRoutineDto>>
    {
        ...
        public GetClassRoutineListByCourseDurationIdRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.ClassRoutine> ClassRoutineRepository, IMapper mapper)
        {
            _ClassRoutineRepository = ClassRoutineRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<ClassRoutineDto>> Handle(GetClassRoutineListByCourseDurationIdRequest request, CancellationToken cancellationToken)
        {
