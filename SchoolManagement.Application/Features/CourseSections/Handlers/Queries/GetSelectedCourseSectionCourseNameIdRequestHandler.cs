...
{
    public class GetSelectedCourseSectionCourseNameIdRequestHandler : IRequestHandler<GetSelectedCourseSectionByBaseNameIdAndCourseNameIdRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<CourseSection> _CourseSectionRepository;


        public GetSelectedCourseSectionCourseNameIdRequestHandler(ISchoolManagementRepository<CourseSection> CourseSectionRepository)
        {
        ...
        {
            ICollection<CourseSection> CourseSections = _CourseSectionRepository.Where(x=> x.CourseNameId == request.CourseNameId).ToList();
