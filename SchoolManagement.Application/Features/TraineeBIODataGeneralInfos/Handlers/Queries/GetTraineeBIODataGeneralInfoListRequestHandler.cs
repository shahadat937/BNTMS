...
{
    public class GetTraineeBioDataGeneralInfoListRequestHandler : IRequestHandler<GetTraineeBioDataGeneralInfoListRequest, PagedResult<TraineeBioDataGeneralInfoDto>>
    {
        ...
        public GetTraineeBioDataGeneralInfoListRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.TraineeBioDataGeneralInfo> TraineeBioDataGeneralInfoRepository, IMapper mapper)
        {
            _TraineeBioDataGeneralInfoRepository = TraineeBioDataGeneralInfoRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<TraineeBioDataGeneralInfoDto>> Handle(GetTraineeBioDataGeneralInfoListRequest request, CancellationToken cancellationToken)
        {
