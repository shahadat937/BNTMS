...
{
    public class GetTraineeBioDataGeneralInfoListForCadetRequestHandler : IRequestHandler<GetTraineeBioDataGeneralInfoListForCadetRequest, PagedResult<TraineeBioDataGeneralInfoDto>>
    {
        ...
        public GetTraineeBioDataGeneralInfoListForCadetRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.TraineeBioDataGeneralInfo> TraineeBioDataGeneralInfoRepository, IMapper mapper)
        {
            _TraineeBioDataGeneralInfoRepository = TraineeBioDataGeneralInfoRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<TraineeBioDataGeneralInfoDto>> Handle(GetTraineeBioDataGeneralInfoListForCadetRequest request, CancellationToken cancellationToken)
        {
