...
{
    public class GetAutoCompletePnoForNbcdRequestHandler : IRequestHandler<GetAutoCompletePnoForNbcdRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<TraineeBioDataGeneralInfo> _TraineeBioDataGeneralInfoRepository; 
        public GetAutoCompletePnoForNbcdRequestHandler(ISchoolManagementRepository<TraineeBioDataGeneralInfo> TraineeBioDataGeneralInfoRepository)
        {
            _TraineeBioDataGeneralInfoRepository = TraineeBioDataGeneralInfoRepository;
        }
          
        public async Task<List<SelectedModel>> Handle(GetAutoCompletePnoForNbcdRequest request, CancellationToken cancellationToken)
        {
