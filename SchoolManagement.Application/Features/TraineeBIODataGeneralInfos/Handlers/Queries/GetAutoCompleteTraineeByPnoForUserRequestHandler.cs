...
{
    public class GetAutoCompleteTraineeByPnoForUserRequestHandler : IRequestHandler<GetAutoCompleteTraineeByPnoForUserRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<TraineeBioDataGeneralInfo> _TraineeBioDataGeneralInfoRepository; 
        public GetAutoCompleteTraineeByPnoForUserRequestHandler(ISchoolManagementRepository<TraineeBioDataGeneralInfo> TraineeBioDataGeneralInfoRepository)
        {
            _TraineeBioDataGeneralInfoRepository = TraineeBioDataGeneralInfoRepository;
        }
          
        public async Task<List<SelectedModel>> Handle(GetAutoCompleteTraineeByPnoForUserRequest request, CancellationToken cancellationToken)
        {
