...
{
    public class GetSelectedSubjectByBnaSemesterIdRequestHandler : IRequestHandler<GetSelectedSubjectByBnaSemesterIdRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<BnaSubjectName> _BnaSubjectNameRepository;


        public GetSelectedSubjectByBnaSemesterIdRequestHandler(ISchoolManagementRepository<BnaSubjectName> BnaSubjectNameRepository)
        {
            _BnaSubjectNameRepository = BnaSubjectNameRepository;
        }

        public async Task<List<SelectedModel>> Handle(GetSelectedSubjectByBnaSemesterIdRequest request, CancellationToken cancellationToken)
        {
