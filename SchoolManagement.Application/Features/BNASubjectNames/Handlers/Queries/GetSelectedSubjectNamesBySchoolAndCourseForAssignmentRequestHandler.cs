...
{
    public class GetSelectedSubjectNamesBySchoolAndCourseForAssignmentRequestHandler : IRequestHandler<GetSelectedSubjectNamesBySchoolAndCourseForAssignmentRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<BnaSubjectName> _BnaSubjectNameRepository;


        public GetSelectedSubjectNamesBySchoolAndCourseForAssignmentRequestHandler(ISchoolManagementRepository<BnaSubjectName> BnaSubjectNameRepository)
        {
            _BnaSubjectNameRepository = BnaSubjectNameRepository;
        }

        public async Task<List<SelectedModel>> Handle(GetSelectedSubjectNamesBySchoolAndCourseForAssignmentRequest request, CancellationToken cancellationToken)
        {
