...
{
    public class GetTraineeNominationListByCourseDurationIdRequestHandler : IRequestHandler<GetTraineeNominationListByCourseDurationIdRequest, PagedResult<TraineeNominationDto>>
    {
        ...
        public GetTraineeNominationListByCourseDurationIdRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.TraineeNomination> TraineeNominationRepository, IMapper mapper)
        {
            _TraineeNominationRepository = TraineeNominationRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<TraineeNominationDto>> Handle(GetTraineeNominationListByCourseDurationIdRequest request, CancellationToken cancellationToken)
        {
